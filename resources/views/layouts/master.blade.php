      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="/kamar" class=""><i class="fa fa-shopping-bag"></i> <span>Kamar</span></a></li>
            <li><a href="/tipekamar" class=""><i class="fab fa-amazon"></i> <span>Tipe Kamar</span></a></li>
            <li><a href="/reservationdiary" class=""><i class="fab fa-amazon"></i> <span>Reservation Diary</span></a></li>
            <li><a href="/datatamu" class=""><i class="fab fa-amazon"></i> <span>Data Tamu</span></a></li>
